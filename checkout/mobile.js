(()=>{
 ...
 function sync(){
  const map={hudCheckout:$('checkout'),hudScore:$('score'),hudTime:document.querySelector('[data-time]'),hudDarts:document.querySelector('[data-checkouts]'),hudAverage:document.querySelector('[data-average]'),hudBest:document.querySelector('[data-best]'),hudVisit:$('visitSmall'),hudStatus:$('status')};
